...
// This function trigger download and open resume 
...
// Set the fixed width of the typewriter container based on the longest phrase
const longestPhrase = phrases.reduce((a, b) => (a.length > b.length ? a : b));
typewriterText.style.width = `${longestPhrase.length}ch`;
